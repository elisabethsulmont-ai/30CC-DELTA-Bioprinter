 ...
 */
#define E0_AUTO_FAN_PIN -1 // turn of extruder fan when it's temperature is above 50°C
...
//#define EXTRUDER_AUTO_FAN_SPEED 192   // 192 = 75%
...
#define Z_HOME_BUMP_MM 3 // deltas need the same for all three axes
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, 500 } // Feedrates for manual moves along X, Y, Z, E from panel
