...
#define CUSTOM_MACHINE_NAME "FRESH Delta custom printer"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Aluminium bed with 2mm GFK FR4 plate
  //#define DEFAULT_bedKp 166.37
  //#define DEFAULT_bedKi 32.76
  //#define DEFAULT_bedKd 563.32
...
#define DELTA
  ...
  #else
    // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
    #define DELTA_PRINTABLE_RADIUS 60   // (mm)
    // Center-to-center distance of the holes in the diagonal push rods.
  ...
  #define DELTA_HEIGHT 125.00             // (mm) Get this value from G33 auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 100, 1000}
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -150 } //Offset for Probe until it clicks. So no need for paper leveling anymore!
...
#define Z_MAX_POS 187.61 //DELTA_HEIGHT
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, Y_MIN_POS+30, 100 }
  #define NOZZLE_PARK_XY_FEEDRATE 60   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE 0    // (mm/s) Z axis feedrate (not used for delta printers)
#endif
